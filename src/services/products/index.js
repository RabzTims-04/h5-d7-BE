...
/* POST a product */
productsRouter.post("/",checkProductsSchema, checkValidationResult, async(req, res, next)=>{
    try {
...
/* PUT a product */
productsRouter.put("/:id", checkProductsSchema,checkValidationResult, async (req, res, next)=>{
    try {
